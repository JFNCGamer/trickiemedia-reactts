  ...
  return (
    ...
    <header className="bg-slate-100 z-50 flex top-0 sticky justify-between justify-items-center items-center m-0">
      <div className="flex justify-start justify-items-center items-center">
        <a href="#nav">
        <img className="w-20 h-14 m-5" src="https://picsum.photos/seed/picsum/200/300"></img>
        </a>
      ...
      <button id="hamburger-button" className="text-3xl focus:outile-none md:hidden p-5 cursor-pointer">&#9776;</button>
    </header>
    </>
  )
}
